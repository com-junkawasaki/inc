...
structure IncDepRawStrictTypingReadinessAlignmentProvider where
  align : ∀
    {context : List IncDepRawType} {term : IncDepRawTerm}
    {type : IncDepRawType} {typing : IncDepRawHasType context term type}
    {formation : IncDepRawWellFormed context type}
    {formationReady : IncDepRawCoherentFormationDispatchReady formation}
    (first second : IncDepRawStrictTypingDispatchReady typing formationReady),
    first = second

def IncDepRawStrictTypingReadinessAlignmentProvider.alignment
    (provider : IncDepRawStrictTypingReadinessAlignmentProvider)
    {context : List IncDepRawType} {term : IncDepRawTerm}
    {type : IncDepRawType} {typing : IncDepRawHasType context term type}
    {formation : IncDepRawWellFormed context type}
    {formationReady : IncDepRawCoherentFormationDispatchReady formation}
...
structure IncDepRawCanonicalStrictFormationSubstitutionDispatchResult
    {source target : List IncDepRawType} {type : IncDepRawType}
    {substitution : IncDepRawSubstitution source target}
    {targetFormation : IncDepRawWellFormed target type}
    (targetReady : IncDepRawCoherentFormationDispatchReady targetFormation)
    ...
    (canonical : IncDepRawFormationSubstitutionFiberResult
      (targetFormation := targetFormation) substitutionResult) where
  dispatchResult : IncDepRawStrictFormationSubstitutionDispatchResult
    targetReady substitutionResult
  provenance : IncDepRawCanonicalFormationFiberResult canonical
    dispatchResult.formationResult

structure IncDepRawSomeCanonicalStrictFormationSubstitutionDispatchResult
    {source target : List IncDepRawType} {type : IncDepRawType}
    {substitution : IncDepRawSubstitution source target}
    {targetFormation : IncDepRawWellFormed target type}
    (targetReady : IncDepRawCoherentFormationDispatchReady targetFormation)
...
structure IncDepRawSomeCanonicalStrictTypingSubstitutionDispatchResult
    {source target : List IncDepRawType} {term : IncDepRawTerm}
    {type : IncDepRawType}
    {substitution : IncDepRawSubstitution source target}
    {targetTyping : IncDepRawHasType target term type}
...
def IncDepRawStrictTypingSubstitutionDispatchResult.castFormationReady
    {source target : List IncDepRawType} {term : IncDepRawTerm}
    {type : IncDepRawType}
    {substitution : IncDepRawSubstitution source target}
    {targetTyping : IncDepRawHasType target term type}
    ...
    {firstReady secondReady :
      IncDepRawCoherentFormationDispatchReady targetFormation}
    {typingReady : IncDepRawStrictTypingDispatchReady targetTyping firstReady}
    {sourceWellFormed : IncDepRawContext.WellFormed source}
    {targetWellFormed : IncDepRawContext.WellFormed target}
    {sourceResult : IncDepRawContextSemanticResult sourceWellFormed}
    {targetResult : IncDepRawContextSemanticResult targetWellFormed}
    {substitutionResult : IncDepRawSubstitutionSemanticResult substitution
      sourceResult targetResult}
    (result : IncDepRawStrictTypingSubstitutionDispatchResult typingReady
      substitutionResult)
    (readinessEq : firstReady = secondReady) :
    IncDepRawStrictTypingSubstitutionDispatchResult
      (typingReady.castFormationReady readinessEq) substitutionResult := by
  cases readinessEq
  exact result

def IncDepRawStrictTypingSubstitutionDispatchResult.castReady
    {source target : List IncDepRawType} {term : IncDepRawTerm}
    {type : IncDepRawType}
    {substitution : IncDepRawSubstitution source target}
    {targetTyping : IncDepRawHasType target term type}
    ...
    {targetFormationReady :
      IncDepRawCoherentFormationDispatchReady targetFormation}
    {firstReady secondReady : IncDepRawStrictTypingDispatchReady targetTyping
      targetFormationReady}
    {sourceWellFormed : IncDepRawContext.WellFormed source}
    {targetWellFormed : IncDepRawContext.WellFormed target}
    {sourceResult : IncDepRawContextSemanticResult sourceWellFormed}
    ...
    {substitutionResult : IncDepRawSubstitutionSemanticResult substitution
      sourceResult targetResult}
    (result : IncDepRawStrictTypingSubstitutionDispatchResult firstReady
      substitutionResult)
    (readinessEq : firstReady = secondReady) :
    IncDepRawStrictTypingSubstitutionDispatchResult secondReady
...
def IncDepRawStrictFormationSubstitutionDispatchResult.castReady
    {source target : List IncDepRawType} {type : IncDepRawType}
    {substitution : IncDepRawSubstitution source target}
    {targetFormation : IncDepRawWellFormed target type}
    {firstReady secondReady :
    ...
    {substitutionResult : IncDepRawSubstitutionSemanticResult substitution
      sourceResult targetResult}
    (result : IncDepRawStrictFormationSubstitutionDispatchResult firstReady
      substitutionResult)
    (readinessEq : firstReady = secondReady) :
    IncDepRawStrictFormationSubstitutionDispatchResult secondReady
      substitutionResult := by
  cases readinessEq
  exact result
...
def IncDepRawSubstitutionFiberModel.dispatchCanonicalBaseFormation
    (model : IncDepRawSubstitutionFiberModel.{u})
    {source target : List IncDepRawType} {index : Nat}
    {substitution : IncDepRawSubstitution source target}
    {sourceWellFormed : IncDepRawContext.WellFormed source}
    ...
    IncDepRawCanonicalStrictFormationSubstitutionDispatchResult
      (IncDepRawCoherentFormationDispatchReady.base
        (context := target) (index := index))
      (model.base substitutionResult) where
  dispatchResult := model.dispatchStrictBaseFormation substitutionResult
  provenance := .canonical _

def IncDepRawSubstitutionFiberModel.dispatchCanonicalUnitFormation
    (model : IncDepRawSubstitutionFiberModel.{u})
    {source target : List IncDepRawType}
    {substitution : IncDepRawSubstitution source target}
    {sourceWellFormed : IncDepRawContext.WellFormed source}
    ...
    IncDepRawCanonicalStrictFormationSubstitutionDispatchResult
      (IncDepRawCoherentFormationDispatchReady.unit (context := target))
      (model.unit substitutionResult) where
  dispatchResult := model.dispatchStrictUnitFormation substitutionResult
  provenance := .canonical _

noncomputable def IncDepRawSubstitutionFiberModel.dispatchCanonicalPiFormation
    (model : IncDepRawSubstitutionFiberModel.{u})
    {source target : List IncDepRawType} {domain codomain : IncDepRawType}
    {substitution : IncDepRawSubstitution source target}
    {domainFormation : IncDepRawWellFormed target domain}
    ...
    IncDepRawCanonicalStrictFormationSubstitutionDispatchResult
      (IncDepRawCoherentFormationDispatchReady.pi domainReady codomainReady)
      (model.pi domainResult.formationResult codomainResult.formationResult) where
  dispatchResult := model.dispatchStrictPiFormation domainResult codomainResult
  provenance := .canonical _

noncomputable def IncDepRawSubstitutionFiberModel.dispatchCanonicalSigmaFormation
    (model : IncDepRawSubstitutionFiberModel.{u})
    {source target : List IncDepRawType} {domain codomain : IncDepRawType}
    {substitution : IncDepRawSubstitution source target}
    {domainFormation : IncDepRawWellFormed target domain}
    ...
    IncDepRawCanonicalStrictFormationSubstitutionDispatchResult
      (IncDepRawCoherentFormationDispatchReady.sigma domainReady codomainReady)
      (model.sigma domainResult.formationResult codomainResult.formationResult) where
  dispatchResult := model.dispatchStrictSigmaFormation domainResult codomainResult
  provenance := .canonical _
...
noncomputable def
    IncDepRawSubstitutionFiberModel.dispatchCanonicalIdentityFormation
    (model : IncDepRawSubstitutionFiberModel.{u})
    {source target : List IncDepRawType} {type : IncDepRawType}
    {left right : IncDepRawTerm}
    {substitution : IncDepRawSubstitution source target}
    ...
    IncDepRawCanonicalStrictFormationSubstitutionDispatchResult
      ...
      (model.identity typeResult.formationResult leftResult rightResult) where
  dispatchResult := model.dispatchStrictIdentityFormation leftReady rightReady
    typeResult leftResult rightResult
  provenance := .canonical _
...
noncomputable def IncDepRawSubstitutionFiberModel.dispatchCanonicalRefl
    (model : IncDepRawSubstitutionFiberModel.{u})
    {source target : List IncDepRawType} {term : IncDepRawTerm}
    {type : IncDepRawType}
    {substitution : IncDepRawSubstitution source target}
    ...
    IncDepRawCanonicalStrictTypingSubstitutionDispatchResult
      (IncDepRawStrictTypingDispatchReady.reflRule typeReady termReady)
      (model.identity termResult.formationResult termResult.typingResult
        termResult.typingResult) where
  dispatchResult := model.dispatchStrictRefl typeReady termReady termResult
  formationProvenance := .canonical _
...
noncomputable def IncDepRawSubstitutionFiberModel.dispatchCanonicalLambda
    (model : IncDepRawSubstitutionFiberModel.{u})
    {source target : List IncDepRawType} {domain codomain : IncDepRawType}
    {body : IncDepRawTerm}
    {substitution : IncDepRawSubstitution source target}
    ...
    IncDepRawCanonicalStrictTypingSubstitutionDispatchResult
      (IncDepRawStrictTypingDispatchReady.lambdaRule domainReady codomainReady
        bodyReady)
      (model.pi domainResult bodyResult.formationResult) where
  dispatchResult := model.dispatchStrictLambda domainReady codomainReady
    bodyReady domainResult bodyResult
  formationProvenance := .canonical _
...
noncomputable def IncDepRawSubstitutionFiberModel.dispatchStrictFirst
    (model : IncDepRawSubstitutionFiberModel.{u})
    {source target : List IncDepRawType} {domain codomain : IncDepRawType}
    {pair : IncDepRawTerm}
    {substitution : IncDepRawSubstitution source target}
    ...
    IncDepRawStrictTypingSubstitutionDispatchResult
      (IncDepRawStrictTypingDispatchReady.firstRule domainReady codomainReady
        pairReady) substitutionResult where
  formationResult := domainResult
  typingResult := model.first domainResult codomainResult pairResult

noncomputable def IncDepRawSubstitutionFiberModel.dispatchProvenancedFirst
    (model : IncDepRawSubstitutionFiberModel.{u})
    {source target : List IncDepRawType} {domain codomain : IncDepRawType}
    {pair : IncDepRawTerm}
    {substitution : IncDepRawSubstitution source target}
    ...
    (pairReady : IncDepRawStrictTypingDispatchReady pairTyping
      (IncDepRawCoherentFormationDispatchReady.sigma domainReady codomainReady))
    {canonicalDomain : IncDepRawFormationSubstitutionFiberResult
      (targetFormation := domainFormation) substitutionResult}
    (domainResult : IncDepRawCanonicalStrictFormationSubstitutionDispatchResult
      domainReady canonicalDomain)
    (codomainResult : IncDepRawFormationSubstitutionFiberResult
      (targetFormation := codomainFormation)
      domainResult.dispatchResult.formationResult.liftSubstitution)
    (pairResult : IncDepRawTypingSubstitutionFiberResult
      (targetTyping := pairTyping)
      (model.sigma domainResult.dispatchResult.formationResult codomainResult)) :
    IncDepRawCanonicalStrictTypingSubstitutionDispatchResult
      (IncDepRawStrictTypingDispatchReady.firstRule domainReady codomainReady
        pairReady) canonicalDomain where
  dispatchResult := model.dispatchStrictFirst domainReady codomainReady pairReady
    domainResult.dispatchResult.formationResult codomainResult pairResult
  formationProvenance := domainResult.provenance
...
noncomputable def IncDepRawSubstitutionFiberModel.dispatchStrictSecond
    (model : IncDepRawSubstitutionFiberModel.{u})
    {source target : List IncDepRawType} {domain codomain : IncDepRawType}
    {pair : IncDepRawTerm}
    {substitution : IncDepRawSubstitution source target}
    ...
    (pairResult : IncDepRawTypingSubstitutionFiberResult
      (targetTyping := pairTyping) (model.sigma domainResult codomainResult))
    (structuralResult : IncDepRawFormationSubstitutionFiberResult
      (targetFormation := resultFormation) substitutionResult)
    (coherence : IncDepRawInstantiateFormationCoherence domainResult
      codomainResult
      (IncSigmaTerm.first pairResult.sourceTermResult.semanticTerm)
      (IncSigmaTerm.first pairResult.targetTermResult.semanticTerm)
...
noncomputable def
    IncDepRawSubstitutionFiberModel.dispatchProvenancedSecondCanonical
    (model : IncDepRawSubstitutionFiberModel.{u})
    {source target : List IncDepRawType} {domain codomain : IncDepRawType}
    {pair : IncDepRawTerm}
    {substitution : IncDepRawSubstitution source target}
    ...
    IncDepRawCanonicalStrictTypingSubstitutionDispatchResult
      ...
      (IncDepRawFormationSubstitutionFiberResult.instantiateCanonical
        ...
        (by
          funext assignment
          exact congrArg Sigma.fst
            (congrFun pairResult.semanticTerm_coherence assignment))) where
  dispatchResult := model.dispatchStrictSecondCanonical domainReady codomainReady
    resultReady pairReady domainResult codomainResult pairResult
  formationProvenance := .canonical _
...
noncomputable def IncDepRawSubstitutionFiberModel.dispatchStrictApply
    (model : IncDepRawSubstitutionFiberModel.{u})
    {source target : List IncDepRawType} {domain codomain : IncDepRawType}
    {function argument : IncDepRawTerm}
    {substitution : IncDepRawSubstitution source target}
...
noncomputable def
    IncDepRawSubstitutionFiberModel.dispatchProvenancedApplyCanonical
    (model : IncDepRawSubstitutionFiberModel.{u})
    {source target : List IncDepRawType} {domain codomain : IncDepRawType}
    {function argument : IncDepRawTerm}
    {substitution : IncDepRawSubstitution source target}
    ...
    IncDepRawCanonicalStrictTypingSubstitutionDispatchResult
      ...
      (IncDepRawFormationSubstitutionFiberResult.instantiateCanonical
        ...
        argumentResult.sourceTermResult.semanticTerm
        argumentResult.targetTermResult.semanticTerm
        argumentResult.semanticTerm_coherence) where
  dispatchResult := model.dispatchStrictApplyCanonical domainReady codomainReady
    resultReady functionReady argumentReady domainResult codomainResult
    functionResult argumentResult
  formationProvenance := .canonical _
...
noncomputable def IncDepRawSubstitutionFiberModel.dispatchStrictPair
    (model : IncDepRawSubstitutionFiberModel.{u})
    {source target : List IncDepRawType} {domain codomain : IncDepRawType}
    {first second : IncDepRawTerm}
    {substitution : IncDepRawSubstitution source target}
...
noncomputable def IncDepRawSubstitutionFiberModel.dispatchProvenancedPairCanonical
    (model : IncDepRawSubstitutionFiberModel.{u})
    {source target : List IncDepRawType} {domain codomain : IncDepRawType}
    {first second : IncDepRawTerm}
    {substitution : IncDepRawSubstitution source target}
    ...
    IncDepRawCanonicalStrictTypingSubstitutionDispatchResult
      ...
      (model.sigma domainResult codomainResult) where
  dispatchResult := model.dispatchStrictPairCanonical domainReady codomainReady
    resultReady firstReady secondReady domainResult codomainResult firstResult
    secondResult
  formationProvenance := .canonical _
...
structure IncDepRawCanonicalSubstitutionPreservationHypotheses where
  variableProvider : IncDepRawVariableSubstitutionProvider
  readinessProvider : IncDepRawCoherentReadinessAlignmentProvider
  rebaseProvider : IncDepRawFormationSubstitutionFiberRebaseProvider
...
abbrev IncDepRawCanonicalFormationSubstitutionFoldMotive
    {target : List IncDepRawType} {type : IncDepRawType}
    {targetFormation : IncDepRawWellFormed target type}
    (ready : IncDepRawCoherentFormationDispatchReady targetFormation) :=
  ∀ {source : List IncDepRawType}
    ...
    IncDepRawSubstitutionReplacementSemanticResult substitutionResult →
    IncDepRawSomeCanonicalStrictFormationSubstitutionDispatchResult
      ready substitutionResult

abbrev IncDepRawCanonicalTypingSubstitutionFoldMotive
    {target : List IncDepRawType} {term : IncDepRawTerm}
    {type : IncDepRawType}
    {targetTyping : IncDepRawHasType target term type}
    {targetFormation : IncDepRawWellFormed target type}
...
def IncDepRawSubstitutionFiberModel.canonicalMutualFoldBase
    (model : IncDepRawSubstitutionFiberModel.{u})
    {context : List IncDepRawType} {index : Nat} :
    IncDepRawCanonicalFormationSubstitutionFoldMotive
      (IncDepRawCoherentFormationDispatchReady.base
        (context := context) (index := index)) :=
  fun _ _ =>
    let result := model.dispatchCanonicalBaseFormation _
    { canonical := model.base _
      result := result }

def IncDepRawSubstitutionFiberModel.canonicalMutualFoldUnitFormation
    (model : IncDepRawSubstitutionFiberModel.{u})
    {context : List IncDepRawType} :
    IncDepRawCanonicalFormationSubstitutionFoldMotive
      (IncDepRawCoherentFormationDispatchReady.unit (context := context)) :=
  fun _ _ =>
    let result := model.dispatchCanonicalUnitFormation _
...
noncomputable def IncDepRawSubstitutionFiberModel.canonicalMutualFoldPi
    (model : IncDepRawSubstitutionFiberModel.{u})
    {context : List IncDepRawType} {domain codomain : IncDepRawType}
    {domainFormation : IncDepRawWellFormed context domain}
    {codomainFormation : IncDepRawWellFormed (domain :: context) codomain}
  ...
  fun targetTree replacements =>
    ...
    let codomainResult := codomain.result.dispatchResult
    let result := model.dispatchCanonicalPiFormation domainResult codomainResult
    { canonical := model.pi domainResult.formationResult
        codomainResult.formationResult
      result := result }

noncomputable def IncDepRawSubstitutionFiberModel.canonicalMutualFoldSigma
    (model : IncDepRawSubstitutionFiberModel.{u})
    {context : List IncDepRawType} {domain codomain : IncDepRawType}
    {domainFormation : IncDepRawWellFormed context domain}
    {codomainFormation : IncDepRawWellFormed (domain :: context) codomain}
...
noncomputable def
    IncDepRawSubstitutionFiberModel.alignedCanonicalMutualFoldFirst
    (model : IncDepRawSubstitutionFiberModel.{u})
    {context : List IncDepRawType} {domain codomain : IncDepRawType}
    {pair : IncDepRawTerm}
    {domainFormation : IncDepRawWellFormed context domain}
    ...
    (domainIH : IncDepRawCanonicalFormationSubstitutionFoldMotive domainReady)
    (codomainIH : IncDepRawCanonicalFormationSubstitutionFoldMotive codomainReady)
    (pairIH : IncDepRawAlignedCanonicalTypingSubstitutionFoldMotive pairReady)
    (pairAgreement : IncDepRawCanonicalFoldAgreement
      (model.canonicalMutualFoldSigma domainReady codomainReady domainIH
        codomainIH) pairIH) :
    IncDepRawAlignedCanonicalTypingSubstitutionFoldMotive
  ...
  fun targetTree replacements =>
    ...
    let codomain := codomainIH extendedTree liftedReplacements
    let pairResult :=
      (pairAgreement.agree targetTree replacements).typingResultAligned
    let targetReady := IncDepRawStrictTypingDispatchReady.ofCoherent
      (IncDepRawCoherentTypingDispatchReady.firstRule domainReady codomainReady
        pairReady)
    let dispatchResult : IncDepRawStrictTypingSubstitutionDispatchResult
        targetReady _ :=
      { formationResult := domainResult.formationResult
        typingResult := model.first domainResult.formationResult
          codomain.result.dispatchResult.formationResult pairResult }
    let typing : IncDepRawSomeCanonicalStrictTypingSubstitutionDispatchResult
        targetReady _ :=
      { canonical := domain.canonical
        result :=
          { dispatchResult := dispatchResult
            formationProvenance := domain.result.provenance } }
    { formation := domain
      typing := typing
      agreement := { canonical_eq := rfl } }

noncomputable def
    IncDepRawSubstitutionFiberModel.canonicalFoldAgreementFirst
    (model : IncDepRawSubstitutionFiberModel.{u})
    {context : List IncDepRawType} {domain codomain : IncDepRawType}
    {pair : IncDepRawTerm}
    {domainFormation : IncDepRawWellFormed context domain}
    ...
    (pairAgreement : IncDepRawCanonicalFoldAgreement
      (model.canonicalMutualFoldSigma domainReady codomainReady domainIH
        codomainIH) pairIH) :
    IncDepRawCanonicalFoldAgreement domainIH
      (model.alignedCanonicalMutualFoldFirst domainReady codomainReady pairReady
        domainIH codomainIH pairIH pairAgreement) where
  agree := fun _ _ => { canonical_eq := rfl }

noncomputable def
    IncDepRawSubstitutionFiberModel.alignedCanonicalMutualFoldPair
    (model : IncDepRawSubstitutionFiberModel.{u})
    {context : List IncDepRawType} {domain codomain : IncDepRawType}
    {first second : IncDepRawTerm}
    {domainFormation : IncDepRawWellFormed context domain}
    ...
    (domainIH : IncDepRawCanonicalFormationSubstitutionFoldMotive domainReady)
    (codomainIH : IncDepRawCanonicalFormationSubstitutionFoldMotive codomainReady)
    (resultIH : IncDepRawCanonicalFormationSubstitutionFoldMotive resultReady)
    (firstIH : IncDepRawAlignedCanonicalTypingSubstitutionFoldMotive firstReady)
    (secondIH : IncDepRawAlignedCanonicalTypingSubstitutionFoldMotive secondReady)
    (firstAgreement : IncDepRawCanonicalFoldAgreement domainIH firstIH)
    (instantiateAgreement : IncDepRawCanonicalFormationFoldAgreement resultIH
      (IncDepRawCanonicalInstantiateSubstitutionFoldMotive domainReady
        codomainReady resultReady firstReady domainIH codomainIH firstIH
        firstAgreement))
    (secondAgreement : IncDepRawCanonicalFoldAgreement resultIH secondIH) :
    IncDepRawAlignedCanonicalTypingSubstitutionFoldMotive
      (IncDepRawCoherentTypingDispatchReady.pairRule domainReady codomainReady
        resultReady firstReady secondReady) :=
  fun targetTree replacements =>
    let formation := model.canonicalMutualFoldSigma domainReady codomainReady
      domainIH codomainIH targetTree replacements
    let domain := domainIH targetTree replacements
    let domainResult := domain.result.dispatchResult.formationResult
    let extendedTree := IncDepRawContextSemanticTree.extend targetTree
      domainResult.targetFormationResult
    let liftedReplacements := replacements.liftResult domainResult
    let codomain := codomainIH extendedTree liftedReplacements
    let codomainResult := codomain.result.dispatchResult.formationResult
    let firstResult :=
      (firstAgreement.agree targetTree replacements).typingResultAligned
    let instantiated := IncDepRawCanonicalInstantiateSubstitutionFoldMotive
      domainReady codomainReady resultReady firstReady domainIH codomainIH
      firstIH firstAgreement targetTree replacements
    let structural := resultIH targetTree replacements
    have structuralResultEq :
        structural.result.dispatchResult.formationResult =
          instantiated.result.dispatchResult.formationResult := by
      calc
        structural.result.dispatchResult.formationResult = structural.canonical :=
          structural.result.provenance.eq_canonical
        _ = instantiated.canonical :=
          instantiateAgreement.agree targetTree replacements
        _ = instantiated.result.dispatchResult.formationResult :=
          instantiated.result.provenance.eq_canonical.symm
    let secondResult :=
      ((secondAgreement.agree targetTree replacements).typingResultAligned)
        |>.castFormation structuralResultEq
    let canonical := model.sigma domainResult codomainResult
    let targetReady := IncDepRawStrictTypingDispatchReady.ofCoherent
      (IncDepRawCoherentTypingDispatchReady.pairRule domainReady codomainReady
        resultReady firstReady secondReady)
    let dispatchResult : IncDepRawStrictTypingSubstitutionDispatchResult
...
noncomputable def
    IncDepRawSubstitutionFiberModel.canonicalFoldAgreementPair
    (model : IncDepRawSubstitutionFiberModel.{u})
    {context : List IncDepRawType} {domain codomain : IncDepRawType}
    {first second : IncDepRawTerm}
    {domainFormation : IncDepRawWellFormed context domain}
    ...
    IncDepRawCanonicalFoldAgreement
      (model.canonicalMutualFoldSigma domainReady codomainReady domainIH
        codomainIH)
      (model.alignedCanonicalMutualFoldPair domainReady codomainReady resultReady
        firstReady secondReady domainIH codomainIH resultIH firstIH secondIH
        firstAgreement instantiateAgreement secondAgreement) where
  agree := fun _ _ => { canonical_eq := rfl }

noncomputable def
    IncDepRawSubstitutionFiberModel.alignedCanonicalMutualFoldApply
    (model : IncDepRawSubstitutionFiberModel.{u})
    {context : List IncDepRawType} {domain codomain : IncDepRawType}
    {function argument : IncDepRawTerm}
    {domainFormation : IncDepRawWellFormed context domain}
    ...
    (codomainIH : IncDepRawCanonicalFormationSubstitutionFoldMotive codomainReady)
    (resultIH : IncDepRawCanonicalFormationSubstitutionFoldMotive resultReady)
    (functionIH : IncDepRawAlignedCanonicalTypingSubstitutionFoldMotive
      functionReady)
    (argumentIH : IncDepRawAlignedCanonicalTypingSubstitutionFoldMotive
      argumentReady)
    (functionAgreement : IncDepRawCanonicalFoldAgreement
      (model.canonicalMutualFoldPi domainReady codomainReady domainIH codomainIH)
      functionIH)
    (argumentAgreement : IncDepRawCanonicalFoldAgreement domainIH argumentIH)
    (instantiateAgreement : IncDepRawCanonicalFormationFoldAgreement resultIH
      (IncDepRawCanonicalInstantiateSubstitutionFoldMotive domainReady
    ...
    IncDepRawAlignedCanonicalTypingSubstitutionFoldMotive
      (IncDepRawCoherentTypingDispatchReady.applyRule domainReady codomainReady
        resultReady functionReady argumentReady) :=
  fun targetTree replacements =>
    let formation := resultIH targetTree replacements
    let domain := domainIH targetTree replacements
    let domainResult := domain.result.dispatchResult.formationResult
    let extendedTree := IncDepRawContextSemanticTree.extend targetTree
      domainResult.targetFormationResult
    ...
    let codomainResult := codomain.result.dispatchResult.formationResult
    let functionResult :=
      (functionAgreement.agree targetTree replacements).typingResultAligned
    let argumentResult :=
      (argumentAgreement.agree targetTree replacements).typingResultAligned
    let instantiated := IncDepRawCanonicalInstantiateSubstitutionFoldMotive
      domainReady codomainReady resultReady argumentReady domainIH codomainIH
      argumentIH argumentAgreement targetTree replacements
    have instantiatedCanonicalEq :
        instantiated.result.dispatchResult.formationResult =
          formation.canonical := by
      calc
        instantiated.result.dispatchResult.formationResult =
            instantiated.canonical :=
          instantiated.result.provenance.eq_canonical
        _ = formation.canonical :=
          (instantiateAgreement.agree targetTree replacements).symm
    let targetReady := IncDepRawStrictTypingDispatchReady.ofCoherent
      (IncDepRawCoherentTypingDispatchReady.applyRule domainReady codomainReady
        resultReady functionReady argumentReady)
    let dispatchResult : IncDepRawStrictTypingSubstitutionDispatchResult
        targetReady _ :=
      { formationResult := instantiated.result.dispatchResult.formationResult
        typingResult := model.apply resultFormation domainResult codomainResult
          functionResult argumentResult }
    let typing : IncDepRawSomeCanonicalStrictTypingSubstitutionDispatchResult
        targetReady _ :=
      { canonical := formation.canonical
        result :=
          { dispatchResult := dispatchResult
            formationProvenance :=
              { eq_canonical := instantiatedCanonicalEq } } }
    { formation := formation
      typing := typing
      agreement := { canonical_eq := rfl } }

noncomputable def
    IncDepRawSubstitutionFiberModel.canonicalFoldAgreementApply
    (model : IncDepRawSubstitutionFiberModel.{u})
    {context : List IncDepRawType} {domain codomain : IncDepRawType}
    {function argument : IncDepRawTerm}
    {domainFormation : IncDepRawWellFormed context domain}
    ...
    (instantiateAgreement : IncDepRawCanonicalFormationFoldAgreement resultIH
      (IncDepRawCanonicalInstantiateSubstitutionFoldMotive domainReady
        codomainReady resultReady argumentReady domainIH codomainIH argumentIH
        argumentAgreement)) :
    IncDepRawCanonicalFoldAgreement resultIH
      (model.alignedCanonicalMutualFoldApply domainReady codomainReady resultReady
        functionReady argumentReady domainIH codomainIH resultIH functionIH
        argumentIH functionAgreement argumentAgreement instantiateAgreement) where
  agree := fun _ _ => { canonical_eq := rfl }

noncomputable def
    IncDepRawSubstitutionFiberModel.alignedCanonicalMutualFoldSecond
    (model : IncDepRawSubstitutionFiberModel.{u})
    {context : List IncDepRawType} {domain codomain : IncDepRawType}
    {pair : IncDepRawTerm}
    {domainFormation : IncDepRawWellFormed context domain}
    ...
    (instantiateAgreement : IncDepRawCanonicalFormationFoldAgreement resultIH
      (IncDepRawCanonicalInstantiateSubstitutionFoldMotive domainReady
        ...
        domainIH codomainIH
        (model.alignedCanonicalMutualFoldFirst domainReady codomainReady pairReady
          domainIH codomainIH pairIH pairAgreement)
        (model.canonicalFoldAgreementFirst domainReady codomainReady pairReady
          domainIH codomainIH pairIH pairAgreement))) :
    IncDepRawAlignedCanonicalTypingSubstitutionFoldMotive
  ...
  fun targetTree replacements =>
    ...
    let pairResult :=
      (pairAgreement.agree targetTree replacements).typingResultAligned
    let instantiated := IncDepRawCanonicalInstantiateSubstitutionFoldMotive
      domainReady codomainReady resultReady
      (IncDepRawCoherentTypingDispatchReady.firstRule domainReady codomainReady
        pairReady)
      domainIH codomainIH
      (model.alignedCanonicalMutualFoldFirst domainReady codomainReady pairReady
...
noncomputable def
    IncDepRawSubstitutionFiberModel.canonicalFoldAgreementSecond
    (model : IncDepRawSubstitutionFiberModel.{u})
    {context : List IncDepRawType} {domain codomain : IncDepRawType}
    {pair : IncDepRawTerm}
    {domainFormation : IncDepRawWellFormed context domain}
    ...
    (instantiateAgreement : IncDepRawCanonicalFormationFoldAgreement resultIH
      (IncDepRawCanonicalInstantiateSubstitutionFoldMotive domainReady
        ...
        (model.canonicalFoldAgreementFirst domainReady codomainReady pairReady
          domainIH codomainIH pairIH pairAgreement))) :
    IncDepRawCanonicalFoldAgreement resultIH
      (model.alignedCanonicalMutualFoldSecond domainReady codomainReady resultReady
        pairReady domainIH codomainIH resultIH pairIH pairAgreement
        instantiateAgreement) where
  agree := fun _ _ => { canonical_eq := rfl }
...
noncomputable def IncDepRawSubstitutionFiberModel.mutualFoldApply
    (model : IncDepRawSubstitutionFiberModel.{u})
    (readinessAlignment : IncDepRawCoherentReadinessAlignmentProvider)
    (strictAlignment : IncDepRawStrictTypingReadinessAlignmentProvider)
    (rebaseProvider : IncDepRawFormationSubstitutionFiberRebaseProvider)
    ...
    (domainIH : IncDepRawStrictFormationSubstitutionFoldMotive domainReady)
    (codomainIH : IncDepRawStrictFormationSubstitutionFoldMotive codomainReady)
    (resultIH : IncDepRawStrictFormationSubstitutionFoldMotive resultReady)
    (functionIH : IncDepRawStrictTypingSubstitutionFoldMotive functionReady)
    (argumentIH : IncDepRawStrictTypingSubstitutionFoldMotive argumentReady) :
    IncDepRawStrictTypingSubstitutionFoldMotive
      (IncDepRawCoherentTypingDispatchReady.applyRule domainReady codomainReady
        resultReady functionReady argumentReady) :=
  fun targetTree replacements =>
    ...
    let liftedReplacements := replacements.liftResult domainResult.formationResult
    let codomainResult := codomainIH extendedTree liftedReplacements
    let structuralResult := resultIH targetTree replacements
    let functionResult := functionIH targetTree replacements
    let argumentResult := argumentIH targetTree replacements
    ...
    let strictFunction := IncDepRawStrictTypingDispatchReady.ofCoherent
      functionReady
    let strictArgument := IncDepRawStrictTypingDispatchReady.ofCoherent
      argumentReady
    ...
    let result := model.dispatchStrictApply domainReady codomainReady resultReady
...
noncomputable def IncDepRawSubstitutionFiberModel.mutualFoldApplyCanonical
    (model : IncDepRawSubstitutionFiberModel.{u})
    (readinessAlignment : IncDepRawCoherentReadinessAlignmentProvider)
    (strictAlignment : IncDepRawStrictTypingReadinessAlignmentProvider)
    (rebaseProvider : IncDepRawFormationSubstitutionFiberRebaseProvider)
    ...
    (domainIH : IncDepRawStrictFormationSubstitutionFoldMotive domainReady)
    (codomainIH : IncDepRawStrictFormationSubstitutionFoldMotive codomainReady)
    (_resultIH : IncDepRawStrictFormationSubstitutionFoldMotive resultReady)
    (functionIH : IncDepRawStrictTypingSubstitutionFoldMotive functionReady)
    (argumentIH : IncDepRawStrictTypingSubstitutionFoldMotive argumentReady) :
    IncDepRawStrictTypingSubstitutionFoldMotive
      (IncDepRawCoherentTypingDispatchReady.applyRule domainReady codomainReady
  ...
  fun targetTree replacements =>
    ...
    let alignedArgument := (argumentResult.castFormationReady argumentEq)
      |>.normalizeFormation rebaseProvider domainResult.formationResult
    let result := model.dispatchStrictApplyCanonical domainReady codomainReady
      resultReady (strictFunction.castFormationReady functionEq)
      (strictArgument.castFormationReady argumentEq)
      domainResult.formationResult codomainResult.formationResult
      alignedFunction.typingResult alignedArgument.typingResult
    result.castReady (strictAlignment.alignment _ _)

noncomputable def IncDepRawSubstitutionFiberModel.mutualFoldPair
    (model : IncDepRawSubstitutionFiberModel.{u})
    (readinessAlignment : IncDepRawCoherentReadinessAlignmentProvider)
    (strictAlignment : IncDepRawStrictTypingReadinessAlignmentProvider)
    (rebaseProvider : IncDepRawFormationSubstitutionFiberRebaseProvider)
    ...
    (codomainIH : IncDepRawStrictFormationSubstitutionFoldMotive codomainReady)
    (resultIH : IncDepRawStrictFormationSubstitutionFoldMotive resultReady)
    (firstIH : IncDepRawStrictTypingSubstitutionFoldMotive firstReady)
    (secondIH : IncDepRawStrictTypingSubstitutionFoldMotive secondReady) :
    IncDepRawStrictTypingSubstitutionFoldMotive
      (IncDepRawCoherentTypingDispatchReady.pairRule domainReady codomainReady
        resultReady firstReady secondReady) :=
  fun targetTree replacements =>
    ...
    let codomainResult := codomainIH extendedTree liftedReplacements
    let structuralResult := resultIH targetTree replacements
    let firstResult := firstIH targetTree replacements
    let secondResult := secondIH targetTree replacements
    ...
    let coherence := instantiateProvider.dispatch domainResult.formationResult
      ...
      structuralResult.formationResult
    let result := model.dispatchStrictPair domainReady codomainReady resultReady
...
noncomputable def IncDepRawSubstitutionFiberModel.mutualFoldPairCanonical
    (model : IncDepRawSubstitutionFiberModel.{u})
    (readinessAlignment : IncDepRawCoherentReadinessAlignmentProvider)
    (strictAlignment : IncDepRawStrictTypingReadinessAlignmentProvider)
    (rebaseProvider : IncDepRawFormationSubstitutionFiberRebaseProvider)
  ...
  fun targetTree replacements =>
    ...
    let canonicalResult :=
      IncDepRawFormationSubstitutionFiberResult.instantiateCanonical
        resultFormation domainResult.formationResult codomainResult.formationResult
        alignedFirst.typingResult.sourceTermResult.semanticTerm
        alignedFirst.typingResult.targetTermResult.semanticTerm
        alignedFirst.typingResult.semanticTerm_coherence
    let alignedSecond := (secondResult.castFormationReady secondEq)
      |>.normalizeFormation rebaseProvider canonicalResult
    let result := model.dispatchStrictPairCanonical domainReady codomainReady
      resultReady (strictFirst.castFormationReady firstEq)
      (strictSecond.castFormationReady secondEq)
      domainResult.formationResult codomainResult.formationResult
      alignedFirst.typingResult alignedSecond.typingResult
    result.castReady (strictAlignment.alignment _ _)

noncomputable def IncDepRawSubstitutionFiberModel.mutualFoldFirst
    (model : IncDepRawSubstitutionFiberModel.{u})
    (readinessAlignment : IncDepRawCoherentReadinessAlignmentProvider)
    (strictAlignment : IncDepRawStrictTypingReadinessAlignmentProvider)
    (rebaseProvider : IncDepRawFormationSubstitutionFiberRebaseProvider)
    ...
    (domainIH : IncDepRawStrictFormationSubstitutionFoldMotive domainReady)
    (codomainIH : IncDepRawStrictFormationSubstitutionFoldMotive codomainReady)
    (pairIH : IncDepRawStrictTypingSubstitutionFoldMotive pairReady) :
    IncDepRawStrictTypingSubstitutionFoldMotive
      (IncDepRawCoherentTypingDispatchReady.firstRule domainReady codomainReady
        pairReady) :=
  fun targetTree replacements =>
    ...
    let liftedReplacements := replacements.liftResult domainResult.formationResult
    let codomainResult := codomainIH extendedTree liftedReplacements
    let pairResult := pairIH targetTree replacements
    let sigmaReady := IncDepRawCoherentFormationDispatchReady.sigma domainReady
      codomainReady
    ...
    let result := model.dispatchStrictFirst domainReady codomainReady
      (strictPair.castFormationReady pairEq) domainResult.formationResult
      codomainResult.formationResult alignedPair.typingResult
    result.castReady (strictAlignment.alignment _ _)

noncomputable def IncDepRawSubstitutionFiberModel.mutualFoldSecond
    (model : IncDepRawSubstitutionFiberModel.{u})
    (readinessAlignment : IncDepRawCoherentReadinessAlignmentProvider)
    (strictAlignment : IncDepRawStrictTypingReadinessAlignmentProvider)
    (rebaseProvider : IncDepRawFormationSubstitutionFiberRebaseProvider)
  ...
  fun targetTree replacements =>
    ...
    let result := model.dispatchStrictSecond domainReady codomainReady resultReady
      (strictPair.castFormationReady pairEq) domainResult.formationResult
      codomainResult.formationResult alignedPair.typingResult
      structuralResult.formationResult coherence
    result.castReady (strictAlignment.alignment _ _)

noncomputable def IncDepRawSubstitutionFiberModel.mutualFoldSecondCanonical
    (model : IncDepRawSubstitutionFiberModel.{u})
    (readinessAlignment : IncDepRawCoherentReadinessAlignmentProvider)
    (strictAlignment : IncDepRawStrictTypingReadinessAlignmentProvider)
    (rebaseProvider : IncDepRawFormationSubstitutionFiberRebaseProvider)
  ...
  fun targetTree replacements =>
    ...
    let alignedPair := (pairResult.castFormationReady pairEq)
      |>.normalizeFormation rebaseProvider sigmaResult
    let result := model.dispatchStrictSecondCanonical domainReady codomainReady
      resultReady (strictPair.castFormationReady pairEq)
      domainResult.formationResult codomainResult.formationResult
...
def IncDepRawSubstitutionFiberModel.canonicalFormationFoldOutputBase
    ...
    IncDepRawCanonicalFormationFoldOutput
      (IncDepRawCoherentFormationDispatchReady.base
        (context := context) (index := index)) where
  fold := model.canonicalMutualFoldBase

def IncDepRawSubstitutionFiberModel.canonicalFormationFoldOutputUnit
    (model : IncDepRawSubstitutionFiberModel.{u})
    {context : List IncDepRawType} :
    IncDepRawCanonicalFormationFoldOutput
      (IncDepRawCoherentFormationDispatchReady.unit (context := context)) where
  fold := model.canonicalMutualFoldUnitFormation

noncomputable def IncDepRawSubstitutionFiberModel.canonicalFormationFoldOutputPi
    (model : IncDepRawSubstitutionFiberModel.{u})
    {context : List IncDepRawType} {domain codomain : IncDepRawType}
    {domainFormation : IncDepRawWellFormed context domain}
    {codomainFormation : IncDepRawWellFormed (domain :: context) codomain}
    ...
    IncDepRawCanonicalFormationFoldOutput
      (IncDepRawCoherentFormationDispatchReady.pi domainReady codomainReady) where
  fold := model.canonicalMutualFoldPi domainReady codomainReady domainOutput.fold
    codomainOutput.fold

noncomputable def
    IncDepRawSubstitutionFiberModel.canonicalFormationFoldOutputSigma
    (model : IncDepRawSubstitutionFiberModel.{u})
    {context : List IncDepRawType} {domain codomain : IncDepRawType}
    {domainFormation : IncDepRawWellFormed context domain}
    {codomainFormation : IncDepRawWellFormed (domain :: context) codomain}
    ...
    (codomainOutput : IncDepRawCanonicalFormationFoldOutput codomainReady) :
    IncDepRawCanonicalFormationFoldOutput
      (IncDepRawCoherentFormationDispatchReady.sigma domainReady
        codomainReady) where
  fold := model.canonicalMutualFoldSigma domainReady codomainReady
    domainOutput.fold codomainOutput.fold

def IncDepRawCanonicalFormationSubstitutionFoldMotive.castReady
    {target : List IncDepRawType} {type : IncDepRawType}
    {targetFormation : IncDepRawWellFormed target type}
    {firstReady secondReady :
      IncDepRawCoherentFormationDispatchReady targetFormation}
    (fold : IncDepRawCanonicalFormationSubstitutionFoldMotive firstReady)
    (readyEq : firstReady = secondReady) :
    IncDepRawCanonicalFormationSubstitutionFoldMotive secondReady :=
  fun targetTree replacements =>
    (fold targetTree replacements).castReady readyEq

def IncDepRawCanonicalFormationSubstitutionFoldMotive.castReadyAgreement
    {target : List IncDepRawType} {type : IncDepRawType}
    {targetFormation : IncDepRawWellFormed target type}
    {firstReady secondReady :
      IncDepRawCoherentFormationDispatchReady targetFormation}
    (fold : IncDepRawCanonicalFormationSubstitutionFoldMotive firstReady)
    (readyEq : firstReady = secondReady) :
    IncDepRawCanonicalFormationFoldAgreement (fold.castReady readyEq) fold := by
  cases readyEq
  exact .refl fold
...
structure IncDepRawCanonicalAnchoredTypingFoldOutput
    {context : List IncDepRawType} {term : IncDepRawTerm}
    {type : IncDepRawType} {typing : IncDepRawHasType context term type}
    {formation : IncDepRawWellFormed context type}
    {formationReady : IncDepRawCoherentFormationDispatchReady formation}
    (typingReady : IncDepRawCoherentTypingDispatchReady typing formation)
    (formationOutput : IncDepRawCanonicalFormationFoldOutput formationReady) where
...
def IncDepRawCanonicalAnchoredTypingFoldOutput.toTypingFoldOutput
    ...
    {typingReady : IncDepRawCoherentTypingDispatchReady typing formation}
    {formationOutput : IncDepRawCanonicalFormationFoldOutput formationReady}
    (output : IncDepRawCanonicalAnchoredTypingFoldOutput typingReady
      formationOutput) :
    IncDepRawCanonicalTypingFoldOutput typingReady where
  formationReady := formationReady
  formation := formationOutput.fold
...
def IncDepRawCanonicalTypingFoldOutput.anchor
    ...
    IncDepRawCanonicalAnchoredTypingFoldOutput typingReady formationOutput where
  typing := output.typing
...
def IncDepRawCanonicalTypingFoldOutput.retargetFormation
    ...
    {newFormationReady : IncDepRawCoherentFormationDispatchReady formation}
  ...
  formationReady := newFormationReady
  formation := newFormation
  typing := output.typing
  agreement := IncDepRawCanonicalFoldAgreement.retargetFormation
    formationAgreement output.agreement

def IncDepRawCanonicalTypingFoldOutput.castFormationReady
    {context : List IncDepRawType} {term : IncDepRawTerm}
    {type : IncDepRawType} {typing : IncDepRawHasType context term type}
    {formation : IncDepRawWellFormed context type}
    {ready : IncDepRawCoherentTypingDispatchReady typing formation}
    (output : IncDepRawCanonicalTypingFoldOutput ready)
    (targetReady : IncDepRawCoherentFormationDispatchReady formation)
    (readyEq : output.formationReady = targetReady) :
    IncDepRawCanonicalTypingFoldOutput ready := by
  cases readyEq
  exact
    { formationReady := output.formationReady
...
def IncDepRawSubstitutionFiberModel.canonicalTypingFoldOutputUnit
  ...
  formationReady := IncDepRawCoherentFormationDispatchReady.unit
...
noncomputable def
    ...
    IncDepRawCanonicalTypingFoldOutput
      (IncDepRawCoherentTypingDispatchReady.lambdaRule domainReady bodyReady) :=
  let bodyReadyEq := readinessAlignment.alignFormation bodyOutput.formationReady
    bodyReady.formationReady
  { formationReady := IncDepRawCoherentFormationDispatchReady.pi domainReady
    ...
    formation := model.canonicalMutualFoldPi domainReady bodyReady.formationReady
      domainOutput.fold
      (IncDepRawCanonicalFormationSubstitutionFoldMotive.castReady
        bodyOutput.formation bodyReadyEq)
...
noncomputable def
    IncDepRawSubstitutionFiberModel.anchoredTypingFoldResultApplyExact
    (model : IncDepRawSubstitutionFiberModel.{u})
    ...
    (functionOutput : IncDepRawCanonicalAnchoredTypingFoldOutput functionReady
      (model.canonicalFormationFoldOutputPi domainReady codomainReady domainOutput
        codomainOutput))
  ...
  let instantiateAgreement := instantiateAgreementProvider.dispatch domainReady
    ...
    resultOutput.fold argumentOutput.typing argumentOutput.agreement
  { formationReady := resultReady
    formationOutput := resultOutput
    output :=
      { typing := model.alignedCanonicalMutualFoldApply domainReady codomainReady
          ...
          codomainOutput.fold resultOutput.fold functionOutput.typing
          argumentOutput.typing functionOutput.agreement argumentOutput.agreement
...
noncomputable def
    IncDepRawSubstitutionFiberModel.anchoredTypingFoldResultPairExact
    (model : IncDepRawSubstitutionFiberModel.{u})
    (instantiateAgreementProvider :
      IncDepRawCanonicalInstantiateFoldAgreementProvider.{u})
    {context : List IncDepRawType} {domain codomain : IncDepRawType}
    ...
    (codomainOutput : IncDepRawCanonicalFormationFoldOutput codomainReady)
    (resultOutput : IncDepRawCanonicalFormationFoldOutput resultReady)
    (firstOutput : IncDepRawCanonicalAnchoredTypingFoldOutput firstReady
      domainOutput)
    (secondOutput : IncDepRawCanonicalAnchoredTypingFoldOutput secondReady
      resultOutput) :
    IncDepRawCanonicalAnchoredTypingFoldResult
      (IncDepRawCoherentTypingDispatchReady.pairRule domainReady codomainReady
        resultReady firstReady secondReady) :=
  let instantiateAgreement := instantiateAgreementProvider.dispatch domainReady
    ...
    resultOutput.fold firstOutput.typing firstOutput.agreement
  { formationReady := IncDepRawCoherentFormationDispatchReady.sigma domainReady
      codomainReady
    formationOutput := model.canonicalFormationFoldOutputSigma domainReady
      codomainReady domainOutput codomainOutput
    output :=
      { typing := model.alignedCanonicalMutualFoldPair domainReady codomainReady
          resultReady firstReady secondReady domainOutput.fold
          codomainOutput.fold resultOutput.fold firstOutput.typing
          secondOutput.typing firstOutput.agreement instantiateAgreement
          secondOutput.agreement
...
noncomputable def
    IncDepRawSubstitutionFiberModel.anchoredTypingFoldResultSecondExact
    (model : IncDepRawSubstitutionFiberModel.{u})
    (instantiateAgreementProvider :
      IncDepRawCanonicalInstantiateFoldAgreementProvider.{u})
    {context : List IncDepRawType} {domain codomain : IncDepRawType}
    ...
    IncDepRawCanonicalAnchoredTypingFoldResult
      (IncDepRawCoherentTypingDispatchReady.secondRule domainReady codomainReady
        resultReady pairReady) :=
  let firstResult := model.anchoredTypingFoldResultFirstExact domainReady
    codomainReady pairReady domainOutput codomainOutput pairOutput
  let instantiateAgreement := instantiateAgreementProvider.dispatch domainReady
    codomainReady resultReady
    (IncDepRawCoherentTypingDispatchReady.firstRule domainReady codomainReady
      pairReady)
    domainOutput.fold codomainOutput.fold resultOutput.fold
    firstResult.output.typing firstResult.output.agreement
  { formationReady := resultReady
    formationOutput := resultOutput
    output :=
      { typing := model.alignedCanonicalMutualFoldSecond domainReady
          codomainReady resultReady pairReady domainOutput.fold
          codomainOutput.fold resultOutput.fold pairOutput.typing
          pairOutput.agreement instantiateAgreement
        agreement := model.canonicalFoldAgreementSecond domainReady
          codomainReady resultReady pairReady domainOutput.fold
          codomainOutput.fold resultOutput.fold pairOutput.typing
          pairOutput.agreement instantiateAgreement } }
...
noncomputable def
    ...
    IncDepRawCanonicalTypingFoldOutput
      (IncDepRawCoherentTypingDispatchReady.firstRule domainReady codomainReady
        pairReady) :=
  let sigmaFormation : IncDepRawCanonicalFormationSubstitutionFoldMotive
      (IncDepRawCoherentFormationDispatchReady.sigma domainReady
        codomainReady) :=
    model.canonicalMutualFoldSigma domainReady codomainReady domainOutput.fold
      codomainOutput.fold
  let alignedPair := pairOutput.retargetFormation sigmaFormation
    pairPathAgreement
  { formationReady := domainReady
    formation := domainOutput.fold
    typing := model.alignedCanonicalMutualFoldFirst domainReady codomainReady
      pairReady domainOutput.fold codomainOutput.fold alignedPair.typing
      alignedPair.agreement
    agreement := model.canonicalFoldAgreementFirst domainReady codomainReady
      pairReady domainOutput.fold codomainOutput.fold alignedPair.typing
      alignedPair.agreement }

noncomputable def
    IncDepRawSubstitutionFiberModel.canonicalTypingFoldOutputRefl
    (model : IncDepRawSubstitutionFiberModel.{u})
    (readinessAlignment : IncDepRawCoherentReadinessAlignmentProvider)
    {context : List IncDepRawType} {type : IncDepRawType}
    {term : IncDepRawTerm}
    ...
    (termReady : IncDepRawCoherentTypingDispatchReady termTyping typeFormation)
    (typeOutput : IncDepRawCanonicalFormationFoldOutput typeReady)
    (termOutput : IncDepRawCanonicalTypingFoldOutput termReady)
    (termPathAgreement : IncDepRawCanonicalFormationFoldAgreement typeOutput.fold
      termOutput.formation) :
    IncDepRawCanonicalTypingFoldOutput
      (IncDepRawCoherentTypingDispatchReady.reflRule typeReady termReady) :=
  let alignedTerm := termOutput.retargetFormation typeOutput.fold
    termPathAgreement
  { formationReady := IncDepRawCoherentFormationDispatchReady.identity typeReady
      termReady termReady
    formation := model.canonicalMutualFoldIdentityOfAgreements
      readinessAlignment typeReady termReady termReady typeOutput.fold
      alignedTerm.typing alignedTerm.typing alignedTerm.agreement
      alignedTerm.agreement
    typing := model.alignedCanonicalMutualFoldRefl readinessAlignment typeReady
...
noncomputable def
    IncDepRawSubstitutionFiberModel.canonicalFormationFoldOutputIdentity
    (model : IncDepRawSubstitutionFiberModel.{u})
    (readinessAlignment : IncDepRawCoherentReadinessAlignmentProvider)
    {context : List IncDepRawType} {type : IncDepRawType}
    {left right : IncDepRawTerm}
    ...
    (rightReady : IncDepRawCoherentTypingDispatchReady rightTyping typeFormation)
    (typeOutput : IncDepRawCanonicalFormationFoldOutput typeReady)
    (leftOutput : IncDepRawCanonicalTypingFoldOutput leftReady)
    (rightOutput : IncDepRawCanonicalTypingFoldOutput rightReady)
    (leftPathAgreement : IncDepRawCanonicalFormationFoldAgreement typeOutput.fold
      leftOutput.formation)
    (rightPathAgreement : IncDepRawCanonicalFormationFoldAgreement typeOutput.fold
      rightOutput.formation) :
    IncDepRawCanonicalFormationFoldOutput
      (IncDepRawCoherentFormationDispatchReady.identity typeReady leftReady
        rightReady) :=
  let alignedLeft := leftOutput.retargetFormation typeOutput.fold
    leftPathAgreement
  let alignedRight := rightOutput.retargetFormation typeOutput.fold
    rightPathAgreement
  { fold := model.canonicalMutualFoldIdentityOfAgreements readinessAlignment
      typeReady leftReady rightReady typeOutput.fold alignedLeft.typing
      alignedRight.typing alignedLeft.agreement alignedRight.agreement }
...
inductive IncDepRawCanonicalFormationFoldOutput.Generated
    (model : IncDepRawSubstitutionFiberModel.{u}) : ∀
    {context : List IncDepRawType} {type : IncDepRawType}
    {formation : IncDepRawWellFormed context type}
    {ready : IncDepRawCoherentFormationDispatchReady formation},
  ...
  | pi {context : List IncDepRawType} {domain codomain : IncDepRawType}
      ...
      (domainOutput : IncDepRawCanonicalFormationFoldOutput domainReady)
      (codomainOutput : IncDepRawCanonicalFormationFoldOutput codomainReady) :
      Generated model domainOutput →
      Generated model codomainOutput →
      Generated model
...
inductive IncDepRawCanonicalAnchoredTypingFoldResult.Generated
    (model : IncDepRawSubstitutionFiberModel.{u})
    (variableProvider : IncDepRawVariableSubstitutionProvider) : ∀
    {context : List IncDepRawType} {term : IncDepRawTerm}
    {type : IncDepRawType} {typing : IncDepRawHasType context term type}
    {formation : IncDepRawWellFormed context type}
    {ready : IncDepRawCoherentTypingDispatchReady typing formation},
    IncDepRawCanonicalAnchoredTypingFoldResult.{u} ready → Prop
  | variable {context : List IncDepRawType} {position : Nat}
      {type : IncDepRawType} {lookup : IncDepRawLookup context position type}
      {typeFormation : IncDepRawWellFormed context type}
      {typeReady : IncDepRawCoherentFormationDispatchReady typeFormation}
      (typeOutput : IncDepRawCanonicalFormationFoldOutput typeReady) :
      IncDepRawCanonicalFormationFoldOutput.Generated model typeOutput →
      Generated model variableProvider
        (variableProvider.anchoredTypingFoldResultVariable
          (lookup := lookup) typeReady typeOutput)
  | unit {context : List IncDepRawType} :
      Generated model variableProvider
        (model.anchoredTypingFoldResultUnit (context := context))

theorem IncDepRawCanonicalFormationFoldOutput.Generated.agreement
    {model : IncDepRawSubstitutionFiberModel.{u}}
    (dependentAgreement :
...
inductive IncDepRawCanonicalAnchoredTypingFoldOutput.Generated
  ...
  | pair {context : List IncDepRawType} {domain codomain : IncDepRawType}
      {first second : IncDepRawTerm}
      {domainFormation : IncDepRawWellFormed context domain}
      {codomainFormation : IncDepRawWellFormed (domain :: context) codomain}
      {resultFormation : IncDepRawWellFormed context
      ...
      (secondOutput : IncDepRawCanonicalAnchoredTypingFoldOutput secondReady
        resultOutput) :
      Generated model variableProvider domainOutput firstOutput →
      Generated model variableProvider resultOutput secondOutput →
      Generated model variableProvider
        (model.canonicalFormationFoldOutputSigma domainReady codomainReady
          domainOutput codomainOutput)
        (model.anchoredTypingFoldResultPairExact instantiateAgreementProvider
          domainReady codomainReady resultReady firstReady secondReady
          domainOutput codomainOutput resultOutput firstOutput secondOutput).output
  | second {context : List IncDepRawType} {domain codomain : IncDepRawType}
...
structure IncDepRawCanonicalGeneratedFormationFoldOutput
    (model : IncDepRawSubstitutionFiberModel.{u})
    {context : List IncDepRawType} {type : IncDepRawType}
    {formation : IncDepRawWellFormed context type}
    (ready : IncDepRawCoherentFormationDispatchReady formation) where
...
/-- An anchored typing result packaged with its syntax-directed provenance. -/
structure IncDepRawCanonicalGeneratedAnchoredTypingFoldResult
    (model : IncDepRawSubstitutionFiberModel.{u})
    (variableProvider : IncDepRawVariableSubstitutionProvider)
    {context : List IncDepRawType} {term : IncDepRawTerm}
    {type : IncDepRawType} {typing : IncDepRawHasType context term type}
...
def IncDepRawSubstitutionFiberModel.generatedFormationBase
    (model : IncDepRawSubstitutionFiberModel.{u})
    {context : List IncDepRawType} {index : Nat} :
    IncDepRawCanonicalGeneratedFormationFoldOutput model
      (.base (context := context) (index := index)) where
  output := model.canonicalFormationFoldOutputBase
  generated := .base

def IncDepRawSubstitutionFiberModel.generatedFormationUnit
    (model : IncDepRawSubstitutionFiberModel.{u})
    {context : List IncDepRawType} :
    IncDepRawCanonicalGeneratedFormationFoldOutput model
      (.unit (context := context)) where
  output := model.canonicalFormationFoldOutputUnit
  generated := .unit

noncomputable def IncDepRawSubstitutionFiberModel.generatedFormationPi
    (model : IncDepRawSubstitutionFiberModel.{u})
    {context : List IncDepRawType} {domain codomain : IncDepRawType}
    {domainFormation : IncDepRawWellFormed context domain}
    {codomainFormation : IncDepRawWellFormed (domain :: context) codomain}
    {domainReady : IncDepRawCoherentFormationDispatchReady domainFormation}
    {codomainReady : IncDepRawCoherentFormationDispatchReady codomainFormation}
    (domain : IncDepRawCanonicalGeneratedFormationFoldOutput model domainReady)
    (codomain :
      IncDepRawCanonicalGeneratedFormationFoldOutput model codomainReady) :
    IncDepRawCanonicalGeneratedFormationFoldOutput model
      (.pi domainReady codomainReady) where
  output := model.canonicalFormationFoldOutputPi domainReady codomainReady
    domain.output codomain.output
  generated := .pi domain.output codomain.output domain.generated
    codomain.generated

noncomputable def IncDepRawSubstitutionFiberModel.generatedFormationSigma
    (model : IncDepRawSubstitutionFiberModel.{u})
    {context : List IncDepRawType} {domain codomain : IncDepRawType}
    {domainFormation : IncDepRawWellFormed context domain}
    {codomainFormation : IncDepRawWellFormed (domain :: context) codomain}
    ...
    (codomain :
      IncDepRawCanonicalGeneratedFormationFoldOutput model codomainReady) :
    IncDepRawCanonicalGeneratedFormationFoldOutput model
      (.sigma domainReady codomainReady) where
  output := model.canonicalFormationFoldOutputSigma domainReady codomainReady
    domain.output codomain.output
  generated := .sigma domain.output codomain.output domain.generated
    codomain.generated

noncomputable def IncDepRawVariableSubstitutionProvider.generatedTypingVariable
    (variableProvider : IncDepRawVariableSubstitutionProvider)
    (model : IncDepRawSubstitutionFiberModel.{u})
    {context : List IncDepRawType} {position : Nat} {type : IncDepRawType}
    {lookup : IncDepRawLookup context position type}
    ...
    IncDepRawCanonicalGeneratedAnchoredTypingFoldResult model variableProvider
      (.varRule (lookup := lookup) typeReady) where
  result := variableProvider.anchoredTypingFoldResultVariable typeReady
    typeOutput.output
  generated := .variable typeOutput.output typeOutput.generated

def IncDepRawSubstitutionFiberModel.generatedTypingUnit
    (model : IncDepRawSubstitutionFiberModel.{u})
    (variableProvider : IncDepRawVariableSubstitutionProvider)
    {context : List IncDepRawType} :
    IncDepRawCanonicalGeneratedAnchoredTypingFoldResult model variableProvider
...
noncomputable def IncDepRawSubstitutionFiberModel.generatedTypingOutputPair
    (model : IncDepRawSubstitutionFiberModel.{u})
    (variableProvider : IncDepRawVariableSubstitutionProvider)
    (dependentAgreement :
      IncDepRawCanonicalDependentFormationFoldAgreementProvider model)
    ...
    (result :
      IncDepRawCanonicalGeneratedFormationFoldOutput model resultReady)
    (first : IncDepRawCanonicalGeneratedAnchoredTypingFoldOutput model
      variableProvider firstReady)
    (second : IncDepRawCanonicalGeneratedAnchoredTypingFoldOutput model
      variableProvider secondReady) :
    IncDepRawCanonicalGeneratedAnchoredTypingFoldOutput model variableProvider
  ...
  let firstAgreement : IncDepRawCanonicalFormationFoldAgreement
    ...
    domain.generated.agreementAcrossReady dependentAgreement readinessAlignment
      first.formation.generated
  let secondAgreement : IncDepRawCanonicalFormationFoldAgreement
      result.output.fold second.formation.output.fold :=
    result.generated.agreementAcrossReady dependentAgreement readinessAlignment
      second.formation.generated
  ...
  let alignedSecond := second.output.retargetFormation result.output
    secondAgreement
  exact
    { formation := model.generatedFormationSigma domain codomain
...
noncomputable def IncDepRawSubstitutionFiberModel.generatedTypingOutputSecond
    (model : IncDepRawSubstitutionFiberModel.{u})
    (variableProvider : IncDepRawVariableSubstitutionProvider)
    (dependentAgreement :
      IncDepRawCanonicalDependentFormationFoldAgreementProvider model)
...
noncomputable def IncDepRawSubstitutionFiberModel.preserveFormation
    ...
    {formation : IncDepRawWellFormed context type}
    (ready : IncDepRawCoherentFormationDispatchReady formation) :
    IncDepRawStrictFormationSubstitutionFoldMotive ready :=
  IncDepRawCoherentFormationDispatchReady.rec
    (motive_1 := fun _ ready =>
      IncDepRawStrictFormationSubstitutionFoldMotive ready)
    (motive_2 := fun _ _ ready =>
      IncDepRawStrictTypingSubstitutionFoldMotive ready)
    model.mutualFoldBase
    model.mutualFoldUnitFormation
    model.mutualFoldPi
    model.mutualFoldSigma
    (model.mutualFoldIdentity readinessAlignment rebaseProvider)
    variableProvider.mutualFoldVariable
    model.mutualFoldTypingUnit
    (model.mutualFoldLambda strictAlignment)
    (model.mutualFoldApply readinessAlignment strictAlignment rebaseProvider
      instantiateProvider)
    (model.mutualFoldPair readinessAlignment strictAlignment rebaseProvider
      instantiateProvider)
    (model.mutualFoldFirst readinessAlignment strictAlignment rebaseProvider)
    (model.mutualFoldSecond readinessAlignment strictAlignment rebaseProvider
      instantiateProvider)
    (model.mutualFoldRefl readinessAlignment strictAlignment rebaseProvider)
    ready

noncomputable def IncDepRawSubstitutionFiberModel.preserveTyping
    (model : IncDepRawSubstitutionFiberModel.{u})
    (variableProvider : IncDepRawVariableSubstitutionProvider)
    (readinessAlignment : IncDepRawCoherentReadinessAlignmentProvider)
    (strictAlignment : IncDepRawStrictTypingReadinessAlignmentProvider)
...
noncomputable def IncDepRawSubstitutionFiberModel.preserveFormationCanonical
    (model : IncDepRawSubstitutionFiberModel.{u})
    (variableProvider : IncDepRawVariableSubstitutionProvider)
    (readinessAlignment : IncDepRawCoherentReadinessAlignmentProvider)
    (strictAlignment : IncDepRawStrictTypingReadinessAlignmentProvider)
  ...
  IncDepRawCoherentFormationDispatchReady.rec
    ...
    (motive_2 := fun _ _ ready =>
      IncDepRawStrictTypingSubstitutionFoldMotive ready)
    model.mutualFoldBase model.mutualFoldUnitFormation model.mutualFoldPi
    model.mutualFoldSigma
    (model.mutualFoldIdentity readinessAlignment rebaseProvider)
    variableProvider.mutualFoldVariable model.mutualFoldTypingUnit
    (model.mutualFoldLambda strictAlignment)
    (model.mutualFoldApplyCanonical readinessAlignment strictAlignment
      rebaseProvider)
    (model.mutualFoldPairCanonical readinessAlignment strictAlignment
      rebaseProvider)
    (model.mutualFoldFirst readinessAlignment strictAlignment rebaseProvider)
    (model.mutualFoldSecondCanonical readinessAlignment strictAlignment
      rebaseProvider)
    (model.mutualFoldRefl readinessAlignment strictAlignment rebaseProvider)
    ready

noncomputable def IncDepRawSubstitutionFiberModel.preserveTypingCanonical
    (model : IncDepRawSubstitutionFiberModel.{u})
    (variableProvider : IncDepRawVariableSubstitutionProvider)
    (readinessAlignment : IncDepRawCoherentReadinessAlignmentProvider)
    (strictAlignment : IncDepRawStrictTypingReadinessAlignmentProvider)
...
noncomputable def IncDepRawSubstitutionFiberModel.preservationCanonical
    (model : IncDepRawSubstitutionFiberModel.{u})
    (hypotheses : IncDepRawCanonicalSubstitutionPreservationHypotheses) :
    IncDepRawStrictMutualSubstitutionDispatcher where
  formation :=
...
def incDepRawUnitVariableCoherentReady :
    IncDepRawCoherentTypingDispatchReady incDepRawUnitVariableTyping
      (IncDepRawWellFormed.unit (context := [.unit])) :=
  IncDepRawCoherentTypingDispatchReady.varRule
    IncDepRawCoherentFormationDispatchReady.unit

def incDepRawUnitIdentityCoherentFormationReady :
    IncDepRawCoherentFormationDispatchReady incDepRawUnitIdentityFormation :=
  IncDepRawCoherentFormationDispatchReady.identity
    IncDepRawCoherentFormationDispatchReady.unit
    incDepRawUnitVariableCoherentReady incDepRawUnitVariableCoherentReady

def incDepRawUnitVariableReflTyping :
    IncDepRawHasType [.unit] (.refl (.var 0))
      (.identity .unit (.var 0) (.var 0)) :=
  IncDepRawHasType.reflRule incDepRawUnitVariableTyping

def incDepRawUnitVariableReflCoherentReady :
    IncDepRawCoherentTypingDispatchReady incDepRawUnitVariableReflTyping
      incDepRawUnitIdentityFormation :=
  IncDepRawCoherentTypingDispatchReady.reflRule
    IncDepRawCoherentFormationDispatchReady.unit
    incDepRawUnitVariableCoherentReady

noncomputable def IncDepRawSubstitutionFiberModel.preserveUnitVariableRefl
    (model : IncDepRawSubstitutionFiberModel.{u})
    (hypotheses : IncDepRawCanonicalSubstitutionPreservationHypotheses) :
    IncDepRawStrictTypingSubstitutionDispatchResult
      (IncDepRawStrictTypingDispatchReady.ofCoherent
        incDepRawUnitVariableReflCoherentReady)
      (IncDepRawSubstitutionSemanticResult.identity
        incDepRawOneUnitContextSemantic) :=
  (model.preservationCanonical hypotheses).typing.dispatch
    incDepRawUnitVariableReflCoherentReady incDepRawOneUnitContextSemanticTree
    (IncDepRawSubstitutionReplacementSemanticResult.identity
      incDepRawOneUnitContextSemanticTree)

theorem IncDepRawSubstitutionFiberModel.preserveUnitVariableRefl_coherent
    (model : IncDepRawSubstitutionFiberModel.{u})
    (hypotheses : IncDepRawCanonicalSubstitutionPreservationHypotheses) :
    let result := model.preserveUnitVariableRefl hypotheses
    result.formationResult.semanticFiberEquivalence.transport
        result.typingResult.sourceTermResult.semanticTerm =
      result.typingResult.targetTermResult.semanticTerm.substitute
        (IncDepRawSubstitutionSemanticResult.identity
          incDepRawOneUnitContextSemantic).semanticSubstitution := by
  exact (model.preserveUnitVariableRefl hypotheses).typingResult
    |>.semanticTerm_coherence

def incDepRawClosedUnitIdentityFormation :
    IncDepRawWellFormed [] (.identity .unit .unit .unit) :=
  IncDepRawWellFormed.identity IncDepRawWellFormed.unit
    IncDepRawHasType.unitRule IncDepRawHasType.unitRule

def incDepRawClosedUnitIdentityCoherentReady :
    IncDepRawCoherentFormationDispatchReady
      incDepRawClosedUnitIdentityFormation :=
  IncDepRawCoherentFormationDispatchReady.identity
    IncDepRawCoherentFormationDispatchReady.unit
    IncDepRawCoherentTypingDispatchReady.unitRule
    IncDepRawCoherentTypingDispatchReady.unitRule

def incDepRawClosedUnitReflCoherentReady :
    IncDepRawCoherentTypingDispatchReady
      (IncDepRawHasType.reflRule
        (IncDepRawHasType.unitRule (context := [])))
      incDepRawClosedUnitIdentityFormation :=
...
def incDepRawDependentPairCoherentReady :
    IncDepRawCoherentTypingDispatchReady incDepRawDependentPair_hasType
      incDepRawDependentPair_typeWellFormed :=
  IncDepRawCoherentTypingDispatchReady.pairRule
    IncDepRawCoherentFormationDispatchReady.unit
    incDepRawUnitIdentityCoherentFormationReady
    incDepRawClosedUnitIdentityCoherentReady
    IncDepRawCoherentTypingDispatchReady.unitRule
    incDepRawClosedUnitReflCoherentReady

noncomputable def IncDepRawSubstitutionFiberModel.preserveDependentPair
    (model : IncDepRawSubstitutionFiberModel.{u})
    (hypotheses : IncDepRawCanonicalSubstitutionPreservationHypotheses) :
    IncDepRawStrictTypingSubstitutionDispatchResult
      (IncDepRawStrictTypingDispatchReady.ofCoherent
        incDepRawDependentPairCoherentReady)
      (IncDepRawSubstitutionSemanticResult.identity
        incDepRawEmptyContextSemantic) :=
  (model.preservationCanonical hypotheses).typing.dispatch
    incDepRawDependentPairCoherentReady incDepRawEmptyContextSemanticTree
    (IncDepRawSubstitutionReplacementSemanticResult.identity
      incDepRawEmptyContextSemanticTree)

theorem IncDepRawSubstitutionFiberModel.preserveDependentPair_coherent
    (model : IncDepRawSubstitutionFiberModel.{u})
    (hypotheses : IncDepRawCanonicalSubstitutionPreservationHypotheses) :
    let result := model.preserveDependentPair hypotheses
    result.formationResult.semanticFiberEquivalence.transport
        result.typingResult.sourceTermResult.semanticTerm =
      result.typingResult.targetTermResult.semanticTerm.substitute
        (IncDepRawSubstitutionSemanticResult.identity
...
def incDepRawDependentPairFirstCoherentReady :
    IncDepRawCoherentTypingDispatchReady incDepRawDependentPair_first_hasType
      (IncDepRawWellFormed.unit (context := [])) :=
  IncDepRawCoherentTypingDispatchReady.firstRule
    IncDepRawCoherentFormationDispatchReady.unit
    incDepRawUnitIdentityCoherentFormationReady
    incDepRawDependentPairCoherentReady

noncomputable def IncDepRawSubstitutionFiberModel.preserveDependentPairFirst
    (model : IncDepRawSubstitutionFiberModel.{u})
    (hypotheses : IncDepRawCanonicalSubstitutionPreservationHypotheses) :
    IncDepRawStrictTypingSubstitutionDispatchResult
      (IncDepRawStrictTypingDispatchReady.ofCoherent
        incDepRawDependentPairFirstCoherentReady)
      (IncDepRawSubstitutionSemanticResult.identity
        incDepRawEmptyContextSemantic) :=
  (model.preservationCanonical hypotheses).typing.dispatch
    incDepRawDependentPairFirstCoherentReady incDepRawEmptyContextSemanticTree
    (IncDepRawSubstitutionReplacementSemanticResult.identity
      incDepRawEmptyContextSemanticTree)

theorem IncDepRawSubstitutionFiberModel.preserveDependentPairFirst_coherent
    (model : IncDepRawSubstitutionFiberModel.{u})
    (hypotheses : IncDepRawCanonicalSubstitutionPreservationHypotheses) :
    let result := model.preserveDependentPairFirst hypotheses
    result.formationResult.semanticFiberEquivalence.transport
        result.typingResult.sourceTermResult.semanticTerm =
      result.typingResult.targetTermResult.semanticTerm.substitute
        (IncDepRawSubstitutionSemanticResult.identity
          incDepRawEmptyContextSemantic).semanticSubstitution := by
  exact (model.preserveDependentPairFirst hypotheses).typingResult
    |>.semanticTerm_coherence

def incDepRawDependentPairSecondFormation :
    IncDepRawWellFormed []
      (.identity .unit (.first incDepRawDependentPair)
        (.first incDepRawDependentPair)) :=
  IncDepRawWellFormed.identity IncDepRawWellFormed.unit
    incDepRawDependentPair_first_hasType incDepRawDependentPair_first_hasType

def incDepRawDependentPairSecondFormationCoherentReady :
    IncDepRawCoherentFormationDispatchReady
      incDepRawDependentPairSecondFormation :=
  IncDepRawCoherentFormationDispatchReady.identity
    IncDepRawCoherentFormationDispatchReady.unit
    incDepRawDependentPairFirstCoherentReady
    incDepRawDependentPairFirstCoherentReady

def incDepRawDependentPairSecondCoherentReady :
    IncDepRawCoherentTypingDispatchReady incDepRawDependentPair_second_hasType
      incDepRawDependentPairSecondFormation :=
  IncDepRawCoherentTypingDispatchReady.secondRule
    IncDepRawCoherentFormationDispatchReady.unit
    incDepRawUnitIdentityCoherentFormationReady
    incDepRawDependentPairSecondFormationCoherentReady
    incDepRawDependentPairCoherentReady

noncomputable def IncDepRawSubstitutionFiberModel.preserveDependentPairSecond
    (model : IncDepRawSubstitutionFiberModel.{u})
    (hypotheses : IncDepRawCanonicalSubstitutionPreservationHypotheses) :
    IncDepRawStrictTypingSubstitutionDispatchResult
      (IncDepRawStrictTypingDispatchReady.ofCoherent
        incDepRawDependentPairSecondCoherentReady)
      (IncDepRawSubstitutionSemanticResult.identity
        incDepRawEmptyContextSemantic) :=
  (model.preservationCanonical hypotheses).typing.dispatch
    incDepRawDependentPairSecondCoherentReady incDepRawEmptyContextSemanticTree
    (IncDepRawSubstitutionReplacementSemanticResult.identity
      incDepRawEmptyContextSemanticTree)

theorem IncDepRawSubstitutionFiberModel.preserveDependentPairSecond_coherent
    (model : IncDepRawSubstitutionFiberModel.{u})
    (hypotheses : IncDepRawCanonicalSubstitutionPreservationHypotheses) :
    let result := model.preserveDependentPairSecond hypotheses
    result.formationResult.semanticFiberEquivalence.transport
        result.typingResult.sourceTermResult.semanticTerm =
      result.typingResult.targetTermResult.semanticTerm.substitute
        (IncDepRawSubstitutionSemanticResult.identity
          incDepRawEmptyContextSemantic).semanticSubstitution := by
  exact (model.preserveDependentPairSecond hypotheses).typingResult
    |>.semanticTerm_coherence

def incDepRawDependentReflCoherentReady :
    IncDepRawCoherentTypingDispatchReady incDepRawDependentRefl_hasType
      incDepRawDependentRefl_typeWellFormed :=
  IncDepRawCoherentTypingDispatchReady.lambdaRule
    IncDepRawCoherentFormationDispatchReady.unit
    (IncDepRawCoherentTypingDispatchReady.reflRule
      IncDepRawCoherentFormationDispatchReady.unit
...
def incDepRawDependentReflApplicationCoherentReady :
    IncDepRawCoherentTypingDispatchReady
      incDepRawDependentRefl_application_hasType
      incDepRawClosedUnitIdentityFormation :=
  IncDepRawCoherentTypingDispatchReady.applyRule
    IncDepRawCoherentFormationDispatchReady.unit
    incDepRawUnitIdentityCoherentFormationReady
    incDepRawClosedUnitIdentityCoherentReady
    incDepRawDependentReflCoherentReady
    IncDepRawCoherentTypingDispatchReady.unitRule

noncomputable def
    IncDepRawSubstitutionFiberModel.preserveDependentReflApplication
    (model : IncDepRawSubstitutionFiberModel.{u})
    (hypotheses : IncDepRawCanonicalSubstitutionPreservationHypotheses) :
    IncDepRawStrictTypingSubstitutionDispatchResult
      (IncDepRawStrictTypingDispatchReady.ofCoherent
        incDepRawDependentReflApplicationCoherentReady)
      (IncDepRawSubstitutionSemanticResult.identity
        incDepRawEmptyContextSemantic) :=
  (model.preservationCanonical hypotheses).typing.dispatch
    incDepRawDependentReflApplicationCoherentReady
...
theorem
    IncDepRawSubstitutionFiberModel.preserveDependentReflApplication_coherent
    (model : IncDepRawSubstitutionFiberModel.{u})
    (hypotheses : IncDepRawCanonicalSubstitutionPreservationHypotheses) :
    let result := model.preserveDependentReflApplication hypotheses
    result.formationResult.semanticFiberEquivalence.transport
        result.typingResult.sourceTermResult.semanticTerm =
      result.typingResult.targetTermResult.semanticTerm.substitute
        (IncDepRawSubstitutionSemanticResult.identity
          incDepRawEmptyContextSemantic).semanticSubstitution := by
  exact (model.preserveDependentReflApplication hypotheses).typingResult
    |>.semanticTerm_coherence
  ...
  formation :=
    { dispatch := fun ready targetTree replacements =>
        model.preserveFormation variableProvider readinessAlignment
          strictAlignment rebaseProvider instantiateProvider ready targetTree
          replacements }
  typing :=
    { dispatch := fun ready targetTree replacements =>
...
noncomputable def IncDepRawSubstitutionFiberModel.foldStrictFormation
    (model : IncDepRawSubstitutionFiberModel.{u})
    ...
    (replacements : IncDepRawSubstitutionReplacementSemanticResult
      substitutionResult) :
    IncDepRawStrictFormationSubstitutionDispatchResult ready
      substitutionResult :=
  match ready with
  | .base => model.dispatchStrictBaseFormation substitutionResult
  | .unit => model.dispatchStrictUnitFormation substitutionResult
  | .pi domainReady codomainReady =>
      let domainResult := model.foldStrictFormation typingDispatcher
        readinessAlignment rebaseProvider domainReady targetTree replacements
      let extendedTree := IncDepRawContextSemanticTree.extend targetTree
        domainResult.formationResult.targetFormationResult
      let liftedReplacements := replacements.liftResult domainResult.formationResult
      let codomainResult := model.foldStrictFormation typingDispatcher
        readinessAlignment rebaseProvider codomainReady extendedTree
          liftedReplacements
      model.dispatchStrictPiFormation domainResult codomainResult
  | .sigma domainReady codomainReady =>
      let domainResult := model.foldStrictFormation typingDispatcher
      ...
      model.dispatchStrictSigmaFormation domainResult codomainResult
  | .identity typeReady leftReady rightReady =>
      let typeResult := model.foldStrictFormation typingDispatcher
        readinessAlignment rebaseProvider typeReady targetTree replacements
      let leftEq := readinessAlignment.alignFormation
        leftReady.formationReady typeReady
      let rightEq := readinessAlignment.alignFormation
        rightReady.formationReady typeReady
      let leftStrict := IncDepRawStrictTypingDispatchReady.ofCoherent leftReady
      let rightStrict := IncDepRawStrictTypingDispatchReady.ofCoherent rightReady
      let leftResult := ((typingDispatcher.run leftReady targetTree replacements)
        |>.castFormationReady leftEq)
        |>.normalizeFormation rebaseProvider typeResult.formationResult
      let rightResult := ((typingDispatcher.run rightReady targetTree replacements)
        |>.castFormationReady rightEq)
        |>.normalizeFormation rebaseProvider typeResult.formationResult
      let result := model.dispatchStrictIdentityFormation
        (leftStrict.castFormationReady leftEq)
...
noncomputable def IncDepRawVariableSubstitutionProvider.foldStrictVariable
    (provider : IncDepRawVariableSubstitutionProvider)
    ...
    (replacements : IncDepRawSubstitutionReplacementSemanticResult
      substitutionResult) :
    IncDepRawStrictTypingSubstitutionDispatchResult
      (IncDepRawStrictTypingDispatchReady.varRule (lookup := lookup) typeReady)
      substitutionResult :=
  let typeResult := formationDispatcher.run typeReady targetTree replacements
  provider.dispatchStrictVariable typeReady targetTree
    typeResult.formationResult replacements

def IncDepRawSubstitutionFiberModel.foldStrictUnit
    (model : IncDepRawSubstitutionFiberModel.{u})
    {source target : List IncDepRawType}
    {substitution : IncDepRawSubstitution source target}
    {sourceWellFormed : IncDepRawContext.WellFormed source}
...
noncomputable def IncDepRawSubstitutionFiberModel.foldStrictRefl
    (model : IncDepRawSubstitutionFiberModel.{u})
    (formationDispatcher : IncDepRawStrictFormationSubstitutionDispatcher)
    (readinessAlignment : IncDepRawCoherentReadinessAlignmentProvider)
    (rebaseProvider : IncDepRawFormationSubstitutionFiberRebaseProvider)
    ...
    (replacements : IncDepRawSubstitutionReplacementSemanticResult
      substitutionResult)
    (termResult : IncDepRawStrictTypingSubstitutionDispatchResult
      (IncDepRawStrictTypingDispatchReady.ofCoherent termReady)
      substitutionResult) :
    IncDepRawStrictTypingSubstitutionDispatchResult
      (IncDepRawStrictTypingDispatchReady.reflRule typeReady
        ((IncDepRawStrictTypingDispatchReady.ofCoherent termReady)
          |>.castFormationReady
            (readinessAlignment.alignFormation termReady.formationReady
              typeReady))) substitutionResult :=
  let typeResult := formationDispatcher.run typeReady targetTree replacements
  let termEq := readinessAlignment.alignFormation termReady.formationReady
    typeReady
  let strictTerm := IncDepRawStrictTypingDispatchReady.ofCoherent termReady
  let alignedTerm := (termResult.castFormationReady termEq)
    |>.normalizeFormation rebaseProvider typeResult.formationResult
  model.dispatchStrictRefl typeReady (strictTerm.castFormationReady termEq)
    alignedTerm

noncomputable def IncDepRawSubstitutionFiberModel.foldStrictLambda
    (model : IncDepRawSubstitutionFiberModel.{u})
    (formationDispatcher : IncDepRawStrictFormationSubstitutionDispatcher)
    (readinessAlignment : IncDepRawCoherentReadinessAlignmentProvider)
    (rebaseProvider : IncDepRawFormationSubstitutionFiberRebaseProvider)
    ...
    (replacements : IncDepRawSubstitutionReplacementSemanticResult
      substitutionResult)
    (bodyResult :
      let domainResult := formationDispatcher.run domainReady targetTree
        replacements
      IncDepRawStrictTypingSubstitutionDispatchResult
        (IncDepRawStrictTypingDispatchReady.ofCoherent bodyReady)
        domainResult.formationResult.liftSubstitution) :
    let strictBody :=
      (IncDepRawStrictTypingDispatchReady.ofCoherent bodyReady)
        |>.castFormationReady
          (readinessAlignment.alignFormation bodyReady.formationReady
            codomainReady)
    IncDepRawStrictTypingSubstitutionDispatchResult
      (IncDepRawStrictTypingDispatchReady.lambdaRule domainReady codomainReady
        strictBody) substitutionResult := by
  ...
  let codomainResult := formationDispatcher.run codomainReady extendedTree
    liftedReplacements
  let bodyEq := readinessAlignment.alignFormation bodyReady.formationReady
    codomainReady
  let strictBody := IncDepRawStrictTypingDispatchReady.ofCoherent bodyReady
  let alignedBody := (bodyResult.castFormationReady bodyEq)
    |>.normalizeFormation rebaseProvider codomainResult.formationResult
...
noncomputable def IncDepRawSubstitutionFiberModel.foldStrictTyping
    (model : IncDepRawSubstitutionFiberModel.{u})
    (formationDispatcher : IncDepRawStrictFormationSubstitutionDispatcher)
    (variableProvider : IncDepRawVariableSubstitutionProvider)
    (readinessAlignment : IncDepRawCoherentReadinessAlignmentProvider)
  ...
  match ready with
  | .varRule typeReady =>
      variableProvider.foldStrictVariable formationDispatcher typeReady
        targetTree replacements
  | .unitRule => model.foldStrictUnit substitutionResult
  | .lambdaRule domainReady bodyReady =>
      let domainResult := formationDispatcher.run domainReady targetTree
        replacements
      let extendedTree := IncDepRawContextSemanticTree.extend targetTree
      ...
      let liftedReplacements := replacements.liftResult
        domainResult.formationResult
      let bodyResult := model.foldStrictTyping formationDispatcher
        variableProvider readinessAlignment strictAlignment rebaseProvider
        instantiateProvider bodyReady extendedTree liftedReplacements
      let result := model.foldStrictLambda formationDispatcher readinessAlignment
        rebaseProvider domainReady bodyReady.formationReady bodyReady targetTree
        replacements bodyResult
      result.castReady (strictAlignment.alignment _ _)
  | .applyRule domainReady codomainReady resultReady functionReady
      argumentReady =>
      let functionResult := model.foldStrictTyping formationDispatcher
        variableProvider readinessAlignment strictAlignment rebaseProvider
        instantiateProvider functionReady targetTree replacements
      let argumentResult := model.foldStrictTyping formationDispatcher
        variableProvider readinessAlignment strictAlignment rebaseProvider
        instantiateProvider argumentReady targetTree replacements
      let result := model.foldStrictApply formationDispatcher readinessAlignment
        rebaseProvider instantiateProvider domainReady codomainReady resultReady
        functionReady argumentReady targetTree replacements functionResult
        argumentResult
      result.castReady (strictAlignment.alignment _ _)
  | .pairRule domainReady codomainReady resultReady firstReady secondReady =>
      let firstResult := model.foldStrictTyping formationDispatcher
        variableProvider readinessAlignment strictAlignment rebaseProvider
        instantiateProvider firstReady targetTree replacements
      let secondResult := model.foldStrictTyping formationDispatcher
        variableProvider readinessAlignment strictAlignment rebaseProvider
        instantiateProvider secondReady targetTree replacements
      let result := model.foldStrictPair formationDispatcher readinessAlignment
        rebaseProvider instantiateProvider domainReady codomainReady resultReady
        firstReady secondReady targetTree replacements firstResult secondResult
      result.castReady (strictAlignment.alignment _ _)
  | .firstRule domainReady codomainReady pairReady =>
      let pairResult := model.foldStrictTyping formationDispatcher
        variableProvider readinessAlignment strictAlignment rebaseProvider
        instantiateProvider pairReady targetTree replacements
      let result := model.foldStrictFirst formationDispatcher readinessAlignment
        rebaseProvider domainReady codomainReady pairReady targetTree replacements
        pairResult
      result.castReady (strictAlignment.alignment _ _)
  | .secondRule domainReady codomainReady resultReady pairReady =>
      let pairResult := model.foldStrictTyping formationDispatcher
        variableProvider readinessAlignment strictAlignment rebaseProvider
        instantiateProvider pairReady targetTree replacements
      let result := model.foldStrictSecond formationDispatcher readinessAlignment
        rebaseProvider instantiateProvider domainReady codomainReady resultReady
        pairReady targetTree replacements pairResult
      result.castReady (strictAlignment.alignment _ _)
  | .reflRule typeReady termReady =>
      let termResult := model.foldStrictTyping formationDispatcher
        variableProvider readinessAlignment strictAlignment rebaseProvider
        instantiateProvider termReady targetTree replacements
      let result := model.foldStrictRefl formationDispatcher readinessAlignment
        rebaseProvider typeReady termReady targetTree replacements termResult
      let targetReady := IncDepRawStrictTypingDispatchReady.ofCoherent
        (IncDepRawCoherentTypingDispatchReady.reflRule typeReady termReady)
      let formationEq := readinessAlignment.alignFormation
        (IncDepRawCoherentFormationDispatchReady.identityStrict typeReady
          ((IncDepRawStrictTypingDispatchReady.ofCoherent termReady)
            |>.castFormationReady
              (readinessAlignment.alignFormation termReady.formationReady
...
noncomputable def IncDepRawSubstitutionFiberModel.strictTypingDispatcher
    (model : IncDepRawSubstitutionFiberModel.{u})
    (formationDispatcher : IncDepRawStrictFormationSubstitutionDispatcher)
    (variableProvider : IncDepRawVariableSubstitutionProvider)
    (readinessAlignment : IncDepRawCoherentReadinessAlignmentProvider)
    ...
    (rebaseProvider : IncDepRawFormationSubstitutionFiberRebaseProvider)
    (instantiateProvider : IncDepRawInstantiateFormationCoherenceProvider) :
    IncDepRawStrictTypingSubstitutionDispatcher where
  dispatch := fun ready targetTree replacements =>
    model.foldStrictTyping formationDispatcher variableProvider
      readinessAlignment strictAlignment rebaseProvider instantiateProvider
      ready targetTree replacements
