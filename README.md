...
| Integer/rational/analysis reconstruction | Dedekind-complete additive group plus bundled nonnegative additive and multiplicative commutative monoids checked; distributivity/signed field/analysis open |
