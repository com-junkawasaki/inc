...
| Integer/rational/analysis reconstruction | Dedekind-complete additive group plus a nonnegative commutative multiplicative monoid checked; signed field/analysis open |
