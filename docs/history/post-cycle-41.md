# Theory of Incidence — detailed checked history

> Historical archive of the former root README. For the current project
> dashboard, see [README.md](../../README.md); for authoritative status, see
...
Apply, Pair, and Second.  Variable now also has a native semantic constructor:
an arbitrary well-typed replacement is obtained from
