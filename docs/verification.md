...
| Signed real multiplication | Canonical positive/negative parts with exact signed decomposition; four-term product reconstructed from the nonnegative semiring; commutativity, zero absorption, and exact agreement with nonnegative cut multiplication |
