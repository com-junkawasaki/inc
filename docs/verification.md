...
| Finite-set reconstruction | Extensional subsets of two atoms; boundary membership faithfully represents union, intersection, complement, and difference, with Boolean algebra laws |
