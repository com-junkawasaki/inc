...
| Signed real multiplication | Canonical positive/negative parts with exact signed decomposition; four-term product reconstructed from the nonnegative semiring; commutativity, principal-one identity, zero absorption, exact agreement with nonnegative cut multiplication, and exact reduction of all four sign quadrants to a nonnegative product or its negation |
