...
| Nonnegative real arithmetic | Bundled nonnegative cuts closed under cut addition, with associative/commutative addition and zero identity; positive-rational strict multiplication monotonicity and positive-product reflection/closure; well-formed product cut generated by positive member products; commutative/associative multiplication, principal-one identity, zero absorption, and two-sided order monotonicity |
