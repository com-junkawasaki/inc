...
| Signed real multiplication | Canonical positive/negative parts with exact signed decomposition and negation exchange; four-term product reconstructed from the nonnegative semiring; commutativity, associativity via all eight sign cases, principal-one identity, zero absorption, exact agreement with nonnegative cut multiplication, exact reduction of all four sign quadrants, and distributivity for same-sign summands with either factor sign |
