...
| Nonnegative real arithmetic | Bundled nonnegative cuts closed under cut addition, with associative/commutative addition and zero identity; every nonzero nonnegative cut has positive members cofinal above its members; positive-rational strict multiplication monotonicity and positive-product reflection/closure; well-formed product cut generated by positive member products; commutative/associative multiplication, principal-one identity, zero absorption, two-sided order monotonicity, and the forward distributive inclusion `a*(b+c) ≤ a*b+a*c` |
