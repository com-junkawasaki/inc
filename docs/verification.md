...
| Signed real multiplication | Canonical positive/negative parts with exact signed decomposition and negation exchange; four-term product reconstructed from the nonnegative semiring; commutativity, associativity via all eight sign cases, principal-one identity, zero absorption, exact agreement with nonnegative cut multiplication, exact reduction of all four sign quadrants, and both distributive laws for arbitrary signed inputs, including the mixed-difference case |
