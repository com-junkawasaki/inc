...
| Nonnegative real multiplication | Positive-rational strict multiplication monotonicity and positive-product reflection/closure; bundled nonnegative cuts; well-formed product cut generated by positive member products; commutativity, associativity, principal-one identity, zero absorption, and two-sided order monotonicity |
