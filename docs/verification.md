...
| Linear data | Boundary matrices and Laplacians computed from boundaries; every derived `BᵀB` Laplacian is symmetric with nonnegative diagonal entries and append/cons row-list decomposition |
