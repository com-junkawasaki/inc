...
| Nonnegative real reciprocal | Relational reciprocal lower cut for every nonzero nonnegative real, built from positive rational outside witnesses and rational inverse resonance without a global selector; inhabited/proper/downward/rounded and nonnegative obligations checked; its product with the source is bounded above by principal one |
