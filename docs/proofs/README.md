...
| Faithful rational quotient field resonance and normalized completion | `IncidenceTheory.lean`, `Rationals.lean`, `CrossInstance.lean` | [status](../status.md#existing-mathematics-reconstruction) |
